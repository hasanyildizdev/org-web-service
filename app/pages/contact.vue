...
<template>
    <UPage>
        <UPageSection class="max-w-4xl mx-auto">
            <UPageHeader 
                :headline="$t('Contact Us')"
                :title="$t('Have questions or feedback?')"
                :description="$t('We\'re here to help. Reach out to our team and we\'ll get back to you as soon as possible.')"
